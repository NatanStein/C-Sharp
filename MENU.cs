...
public class MENU : MonoBehaviour
{
    ...
    public Button BotaoJogar, BotaoOpcoes, BotaoSair, BotaoCredits;
    [Space(20)]
    ...
    void Start()
    {
        ...
        BotaoCredits.onClick = new Button.ButtonClickedEvent();
    ...
    private void Opcoes(bool ativarOP)
    {
        ...
        BotaoCredits.gameObject.SetActive(!ativarOP);
